...
public class Grafo {
    ...
    */
    ...
    public Movil dijkstraMovilMasCercano(Punto origen) {
...
//int mini =0;
        ...
        for (int i = 0; i < tope; i++) {
            if (vertices[i] instanceof Movil && ((Movil) vertices[i]).isDisponible() == true && dist[i] < minMovil) {
                posMinMovil = i;
                minMovil = dist[i];
            }
        }
...
//int mini =0;
        ...
        for (int i = 0; i < tope; i++) {
            if (vertices[i] instanceof Delivery && ((Delivery) vertices[i]).isDisponible() == true && dist[i] < minDelivery) {
                posMinDelivery = i;
                minDelivery = dist[i];
            }
        }
